    ...
    <section className="pt-32 pb-20 px-4 min-h-[90vh] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col items-start gap-6">
          ...
          >
            <a href="https://code-city-pied.vercel.app/" className="bg-primary hover:bg-primary-hover text-white font-retro text-sm px-6 py-4 pixel-border-primary transition-all hover:-translate-y-1 active:translate-y-0 group">
              Start Your Quest — Free
              <span className="block text-[10px] opacity-70 mt-1 font-sans">No credit card required</span>
            </a>
            <a href="https://code-city-pied.vercel.app/" className="bg-card hover:bg-border text-foreground font-retro text-sm px-6 py-4 pixel-border flex items-center gap-2 transition-all">
