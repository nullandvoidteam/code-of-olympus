    ...
    <div className="w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8 flex flex-col gap-8 text-left animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
          {/* Section Header */}
          <div
            className={`flex items-center justify-between pb-3 border-b-2 ${isGow ? 'border-red-950/80' : isSpiderman ? 'border-cyan-900/60' : 'border-slate-200'
              }`}
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-10 h-10 rounded-2xl flex items-center justify-center shadow-md border ${isGow
              ...
              <div>
                <h2
                  className={`text-lg font-black tracking-tight ${isGow ? 'text-[#F5E8E8] font-cinzel uppercase' : isSpiderman ? 'text-white' : 'text-slate-900'
                    }`}
                >
                  {isGow ? 'War Clan Battles' : 'Squad Battle Duels'}
                </h2>
                <p
                  className={`text-xs font-medium ${isGow ? 'text-stone-400' : isSpiderman ? 'text-blue-200/70' : 'text-slate-500'
                    }`}
                >
            ...
            {team && (
              <span
                className={`px-3 py-1 rounded-xl text-xs font-black font-mono shadow-sm border ${isGow
          ...
          <div className="flex flex-col gap-6">
            {team ? (
              ...
              <div
                className={`rounded-3xl p-8 sm:p-10 flex flex-col items-center text-center gap-6 border-2 transition-all shadow-xl ${isGow
              ...
              >
                <div
                  className={`w-20 h-20 rounded-3xl flex items-center justify-center text-3xl shadow-xl border-2 ${isGow
                ...
                <div className="flex flex-col gap-2 max-w-xl">
                  <h2
                    className={`text-2xl sm:text-3xl font-black tracking-tight ${isGow ? 'text-[#F5E8E8] font-cinzel uppercase' : isSpiderman ? 'text-white' : 'text-slate-900'
                      }`}
                  >
                    {isGow ? 'Clan-vs-Clan Battle Grounds' : 'Team-vs-Team Battle Arena'}
                  </h2>
                  <p
                    className={`text-xs sm:text-sm leading-relaxed font-semibold ${isGow ? 'text-stone-300' : isSpiderman ? 'text-blue-100/90' : 'text-slate-600'
                      }`}
                  >
                    {isGow
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-2xl pt-2">
                  <div
                    className={`p-4 rounded-2xl border-2 flex flex-col items-center gap-1.5 shadow-sm transition-transform hover:-translate-y-1 ${isGow
                  ...
                  >
                    <span
                      className={`w-8 h-8 rounded-xl flex items-center justify-center text-xs font-black shadow-sm ${isGow
                    ...
                    <span
                      className={`font-black text-xs ${isGow ? 'text-amber-400 font-cinzel' : isSpiderman ? 'text-cyan-300' : 'text-rose-700'
                        }`}
                    >
                      {isGow ? 'Declare Clan War' : 'Challenge Squads'}
                    </span>
                    <span
                      className={`text-[11px] text-center font-medium ${isGow ? 'text-stone-400' : isSpiderman ? 'text-blue-200/80' : 'text-slate-600'
                        }`}
                    >
                  ...
                  >
                    ...
                    <span
                      className={`font-black text-xs ${isGow ? 'text-amber-400 font-cinzel' : isSpiderman ? 'text-blue-300' : 'text-amber-700'
                        }`}
                    >
                  ...
                  >
                    ...
                    <span
                      className={`font-black text-xs ${isGow ? 'text-emerald-400 font-cinzel' : isSpiderman ? 'text-teal-300' : 'text-emerald-700'
                        }`}
                    >
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div
            className={`flex items-center gap-2 pb-3 border-b-2 ${isGow ? 'border-red-950/80' : isSpiderman ? 'border-cyan-900/60' : 'border-slate-200'
              }`}
          >
            <div
              className={`w-8 h-8 rounded-xl flex items-center justify-center font-black text-xs border ${isGow
            ...
            <h2
              className={`text-base font-black uppercase tracking-wider ${isGow ? 'text-[#F5E8E8] font-cinzel' : isSpiderman ? 'text-white' : 'text-slate-900'
                }`}
            >
          ...
          {team ? (
            <div className="flex flex-col gap-4">
              ...
              <div
                className={`rounded-3xl p-6 border-2 flex flex-col gap-5 shadow-xl transition-all ${isGow
              ...
              >
                <div className="flex items-center gap-3.5">
                  <div
                    className={`w-14 h-14 rounded-2xl flex items-center justify-center text-2xl font-black shrink-0 shadow-md border-2 ${isGow
                  ...
                  <div className="flex flex-col min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      <span
                        className={`text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded-md border ${isGow
                      ...
                      {isCaptain && (
                        <span
                          className={`px-2 py-0.5 rounded-full text-[10px] font-black uppercase border ${isGow
                    ...
                    <h3
                      className={`font-black text-lg truncate mt-0.5 ${isGow ? 'text-[#F5E8E8] font-cinzel' : isSpiderman ? 'text-white' : 'text-slate-900'
                        }`}
                    >
                      {team.name}
                    </h3>
                    <div className="flex items-center gap-2 mt-1">
                      <span
                        className={`text-xs font-bold font-mono ${isGow ? 'text-stone-300' : isSpiderman ? 'text-blue-200/80' : 'text-slate-600'
                          }`}
                      >
                        {members.length} / 4 {isGow ? 'Warriors' : 'Members'}
                      </span>
                      <span
                        className={`text-xs font-black px-2.5 py-0.5 rounded-full border ${isGow
                ...
                {/* Squad Roster */}
                <div
                  className={`flex flex-col gap-2 pt-3 border-t ${isGow ? 'border-red-900/50' : isSpiderman ? 'border-cyan-900/50' : 'border-slate-100'
                    }`}
                >
                  <span
                    className={`text-[11px] font-black uppercase tracking-wider flex items-center gap-1.5 ${isGow ? 'text-amber-400 font-cinzel' : isSpiderman ? 'text-cyan-300' : 'text-slate-700'
                      }`}
                  >
                  ...
                  <div className="flex flex-col gap-2">
                    {members.map((m) => (
                      <div
                        key={m.id}
                        className={`flex items-center justify-between p-2.5 rounded-2xl border transition-all text-xs ${isGow
                      ...
                      >
                        <div className="flex items-center gap-2.5 min-w-0">
                          <div
                            className={`w-7 h-7 rounded-full text-white font-black flex items-center justify-center text-xs shadow-xs ${isGow
                        ...
                        {m.role === 'captain' && (
                          <span
                            className={`text-[9px] font-black px-2 py-0.5 rounded-md border ${isGow
                ...
                <div
                  className={`flex flex-col gap-3 pt-3 border-t ${isGow ? 'border-red-900/50' : isSpiderman ? 'border-cyan-900/50' : 'border-slate-100'
                    }`}
                >
                  <span
                    className={`text-[11px] font-black uppercase tracking-wider ${isGow ? 'text-amber-400 font-cinzel' : isSpiderman ? 'text-cyan-300' : 'text-slate-700'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-3 rounded-2xl border-2 text-xs font-mono font-bold transition-all cursor-pointer shadow-md ${isGow
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 text-xs font-extrabold rounded-2xl transition-colors cursor-pointer text-center border ${isGow
            ...
            <div
              className={`rounded-3xl p-6 sm:p-7 border-2 flex flex-col gap-6 shadow-2xl transition-all ${isGow
            ...
            >
              <div
                className={`text-center pb-4 border-b ${isGow ? 'border-red-900/60' : isSpiderman ? 'border-cyan-900/60' : 'border-slate-100'
                  }`}
              >
                <div
                  className={`w-14 h-14 mx-auto mb-3 rounded-2xl flex items-center justify-center text-2xl shadow-lg border-2 ${isGow
                ...
                <h3
                  className={`font-black text-lg tracking-tight ${isGow ? 'text-[#F5E8E8] font-cinzel uppercase' : isSpiderman ? 'text-white' : 'text-slate-900'
                    }`}
                >
                  {isGow ? 'Forge a War Clan' : 'Squad Up for Battle'}
                </h3>
                <p
                  className={`text-xs mt-1 leading-relaxed font-semibold ${isGow ? 'text-stone-300' : isSpiderman ? 'text-blue-200/80' : 'text-slate-600'
                    }`}
                >
                  {isGow
              ...
              <form
                ...
                className={`flex flex-col gap-3 pb-5 border-b ${isGow ? 'border-red-900/60' : isSpiderman ? 'border-cyan-900/60' : 'border-slate-100'
                  }`}
              >
                <span
                  className={`text-xs font-black uppercase tracking-wider flex items-center gap-1.5 ${isGow ? 'text-amber-400 font-cinzel' : isSpiderman ? 'text-cyan-300' : 'text-slate-800'
                    }`}
                >
                ...
                <input
                  ...
                  className={`w-full text-xs px-4 py-3 rounded-2xl border-2 font-bold focus:outline-none transition-all shadow-inner ${isGow
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-2xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 transition-all shadow-md active:translate-y-0.5 ${isGow
              ...
              <form onSubmit={handleJoinTeam} className="flex flex-col gap-3">
                ...
                <input
                  ...
                  maxLength={6}
                  className={`w-full text-xs px-4 py-3 rounded-2xl border-2 font-mono font-black uppercase tracking-widest focus:outline-none transition-all shadow-inner ${isGow
      ...
      {showLeaveConfirm && team && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-md animate-in fade-in duration-150">
          <div
            className={`w-full max-w-sm flex flex-col p-6 gap-4 rounded-3xl border-2 shadow-2xl ${isGow
          ...
          >
            <div className="flex items-center gap-3 text-rose-500">
              ...
              <h3
                className={`font-black text-lg ${isGow ? 'text-[#F5E8E8] font-cinzel' : isSpiderman ? 'text-white' : 'text-slate-900'
                  }`}
              >
                {isGow ? 'Abandon Clan?' : 'Leave Squad?'}
              </h3>
            ...
            <p
              className={`text-xs leading-relaxed font-semibold ${isGow ? 'text-stone-300' : isSpiderman ? 'text-blue-100' : 'text-slate-600'
                }`}
            >
            ...
            <div className="flex justify-end gap-2.5 mt-2">
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold cursor-pointer transition-colors ${isGow
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold text-white transition-colors cursor-pointer disabled:opacity-50 ${isGow
