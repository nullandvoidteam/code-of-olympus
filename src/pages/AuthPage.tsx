        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center bg-white/90 backdrop-blur-md border border-slate-200/90 p-0.5 rounded-xl shadow-xs">
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold text-xs transition-all cursor-pointer ${authView === 'login'
            ...
            <button
              ...
              className={`px-3 py-1 rounded-lg font-bold text-xs transition-all cursor-pointer ${authView === 'register'
                  ? 'bg-emerald-600 text-white shadow-xs'
                  : 'text-slate-600 hover:text-slate-900'
                }`}
            >
