            ...
            if (theme === 'classic') {
              return (
                <button
                  ...
                  className={cn(
                    "relative flex items-center gap-3 px-3.5 py-2.5 rounded-xl transition-all duration-200 group cursor-pointer text-left",
                    isActive
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          <button
            type="button"
            onClick={() => onSelectTab('settings')}
            className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm uppercase tracking-[0.15em] font-semibold transition-all duration-200 cursor-pointer"
            style={{
              fontFamily: 'var(--theme-font-heading, "Cinzel", serif)',
