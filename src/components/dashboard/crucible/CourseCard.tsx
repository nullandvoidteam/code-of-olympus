...
export const CourseCard: React.FC<CourseCardProps> = ({ courseData, onStartLesson }) => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(145deg, #120909 0%, #090505 100%)',
        border: isCompleted
          ? '1px solid rgba(245, 208, 96, 0.6)'
          : isUnlocked
          ? '1px solid rgba(80, 30, 30, 0.85)'
          : '1px solid #201010',
        boxShadow: isCompleted
          ? '0 0 24px rgba(245, 208, 96, 0.12), 0 4px 20px rgba(7,5,5,0.7)'
          : '0 4px 20px rgba(7,5,5,0.7)',
    ...
    >
      ...
      {!isUnlocked && (
        ...
        >
          <Lock className="w-8 h-8" style={{ color: '#8A7A7A' }} />
          <div className="text-center px-4">
            ...
            {prerequisiteCourseTitle && (
              <p className="text-xs mt-1 font-medium" style={{ color: '#C59B27' }}>
      ...
      <div className="p-6 flex flex-col flex-1 justify-between gap-4">
        <div>
          ...
          {/* Title */}
          <h3
            className="font-bold uppercase tracking-wide text-lg text-stone-100 mb-1.5 leading-snug"
          ...
          {course.description && (
            <p
              ...
              style={{ color: '#8A7A7A', fontFamily: "'Inter', sans-serif" }}
            >
              {course.description}
            </p>
          )}
        ...
        <div>
          ...
          <div className="mb-4">
            <div className="flex justify-between items-center mb-1.5">
              <span style={{ color: '#8A7A7A', fontSize: '10px', fontFamily: "'Inter', sans-serif" }}>
                {completedLessons}/{totalLessons} Trials
              </span>
              <span
                className="font-bold tracking-wider"
                style={{
                  color: progressPercent === 100 ? '#F5D060' : '#FF3D00',
                  fontSize: '11px',
                  fontFamily: "'Cinzel', serif",
                }}
              >
            ...
            <div
              ...
              style={{ background: '#0a0505', border: '1px solid #3D1C1C' }}
            >
              <div
                ...
                style={{
                  ...
                  boxShadow: progressPercent > 0 ? '0 0 8px rgba(255,61,0,0.5)' : 'none',
                }}
              />
            </div>
          </div>
          ...
          {/* Last accessed */}
          {lastAccessedAt && (
            <p style={{ color: '#8A7A7A', fontSize: '10px', marginBottom: '12px' }}>
          ...
          {isCompleted ? (
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl font-bold text-xs uppercase tracking-[0.18em] text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
              style={{
                fontFamily: "'Cinzel', serif",
