...
export const RageGauge: React.FC<RageGaugeProps> = ({ stats }) => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(145deg, #140909 0%, #0A0606 100%)',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3">
        <span
          ...
          style={{ color: '#EF4444', fontSize: '11px', fontFamily: "'Cinzel', serif" }}
        >
          <span>⚔️</span>
        ...
        <span
          ...
          style={{ color: '#F5D060', fontSize: '12px', fontFamily: "'Cinzel', serif" }}
        >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, #090404 0%, #150606 100%)',
