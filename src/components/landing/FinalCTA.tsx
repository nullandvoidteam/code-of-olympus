  ...
  return (
    <section className="py-32 px-4 relative flex flex-col items-center text-center">
      ...
      <div className="container mx-auto max-w-3xl relative z-10 flex flex-col items-center">
        ...
        <a href="#" onClick={(e: any) => { e.preventDefault(); window.dispatchEvent(new Event('navigate-auth')) }} className="bg-primary hover:bg-primary-hover text-white font-retro text-lg px-8 py-5 pixel-border-primary flex items-center gap-3 transition-all hover:-translate-y-1 shadow-[0_0_30px_rgba(217,70,239,0.3)]">
          <GithubIcon />
