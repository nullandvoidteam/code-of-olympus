  ...
  return (
    <section className="py-12 px-4 bg-primary text-white border-y-4 border-primary-hover relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        ...
        <a href="#" onClick={(e: any) => { e.preventDefault(); window.dispatchEvent(new Event('navigate-auth')) }} className="bg-black hover:bg-black/80 text-primary font-retro text-sm px-8 py-4 pixel-border border-black transition-transform hover:scale-105 shrink-0 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
          JOIN BATTLE
        </a>
      </div>
    </section>
