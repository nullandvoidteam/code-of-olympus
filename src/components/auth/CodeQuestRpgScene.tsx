...
export const CodeQuestRpgScene: React.FC = () => {
  return (
    <div className="relative w-full h-[500px] lg:h-[580px] xl:h-[630px] max-h-[calc(100vh-95px)] rounded-3xl overflow-hidden shadow-2xl border-4 border-slate-900/10 bg-slate-900 select-none group">
      ...
      <div className="absolute top-5 left-5 z-20 bg-[#191535]/95 border-2 border-[#382f6b] rounded-2xl p-3 shadow-2xl backdrop-blur-md min-w-[160px] animate-float">
        <div className="flex items-center justify-between gap-2 mb-2">
          <span className="font-pixel text-[9.5px] text-white uppercase tracking-wider font-bold">
            LEVEL 12
          </span>
      ...
      <div className="absolute top-[135px] left-6 z-20 bg-[#251644]/95 border border-[#6432aa] px-3.5 py-1.5 rounded-full shadow-[0_4px_18px_rgba(100,50,170,0.5)] text-[#d8b4fe] font-pixel text-[8.5px] flex items-center gap-1.5 animate-float-delayed backdrop-blur-sm hover:scale-105 transition-transform cursor-default">
        <span className="text-amber-400 text-xs">✦</span>
        <span>+120 XP</span>
      </div>

      {/* HUD OVERLAY 3: FLOATING CASTLE CODE SIGIL */}
      <div className="absolute top-[90px] left-[40%] z-20 bg-[#1a1738]/90 border-2 border-[#4f46e5] px-2.5 py-1 rounded-xl shadow-[0_0_15px_rgba(99,102,241,0.6)] font-pixel text-[9px] text-indigo-300 flex items-center justify-center animate-float-slow">
        &lt;/&gt;
      </div>

      {/* HUD OVERLAY 4: FLOATING COMPANION BOT & SPEECH BUBBLE */}
      <div className="absolute top-5 right-[22%] z-20 flex flex-col items-center animate-float-slow">
      ...
      <div className="absolute top-[150px] right-6 z-20 flex flex-col gap-2.5">
        <div className="w-9 h-9 rounded-xl bg-[#1e293b]/90 border-2 border-sky-400 flex items-center justify-center animate-neon-cyan shadow-lg backdrop-blur-sm hover:scale-110 transition-transform cursor-pointer">
        ...
        <div className="w-9 h-9 rounded-xl bg-[#fcd34d] border-2 border-[#b45309] flex items-center justify-center animate-neon-yellow shadow-lg hover:scale-110 transition-transform cursor-pointer">
          <span className="font-pixel text-[11px] font-black text-black tracking-tighter">
            JS
          </span>
        </div>

        <div className="w-9 h-9 rounded-xl bg-[#f97316]/90 border-2 border-orange-300 flex items-center justify-center animate-neon-orange shadow-lg backdrop-blur-sm hover:scale-110 transition-transform cursor-pointer">
      ...
      <div className="absolute bottom-6 left-6 z-20 flex flex-col items-center">
        <div className="flex flex-col gap-1.5 z-10">
          <div className="relative bg-gradient-to-r from-[#854d0e] to-[#a16207] border-2 border-[#713f12] text-[#fef08a] font-pixel text-[8px] font-bold px-2.5 py-1 rounded-sm shadow-md flex items-center justify-between gap-2 min-w-[78px] hover:brightness-110 transition-all cursor-default">
            <span>BUILD</span>
            <span className="text-[7px] text-amber-200">▶</span>
          </div>
          <div className="relative bg-gradient-to-r from-[#713f12] to-[#854d0e] border-2 border-[#582e0a] text-[#fef08a] font-pixel text-[8px] font-bold px-2.5 py-1 rounded-sm shadow-md flex items-center justify-between gap-2 min-w-[78px] hover:brightness-110 transition-all cursor-default">
            <span>LEARN</span>
            <span className="text-[7px] text-amber-200">▶</span>
          </div>
          <div className="relative bg-gradient-to-r from-[#854d0e] to-[#a16207] border-2 border-[#713f12] text-[#fef08a] font-pixel text-[7.5px] font-bold px-2 py-0.5 rounded-sm shadow-md flex items-center justify-between gap-1 min-w-[78px] hover:brightness-110 transition-all cursor-default">
            <span>LEVEL UP</span>
            <span className="text-[7px] text-amber-200">▶</span>
          </div>
        </div>
        <div className="w-3 h-10 bg-[#582e0a] border-x border-[#3b1d06] -mt-0.5 shadow-inner" />
      </div>
